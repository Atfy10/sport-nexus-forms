...
const SportBranchForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    setIsLoading(true);
    try {
      console.log("Submitting sport-branch relationship:", values);
      await new Promise(resolve => setTimeout(resolve, 1000));
      toast.success("Sport-Branch relationship created successfully");
      form.reset();
    } catch (error) {
  ...
  return (
    <FormLayout title="Link Sport to Branch">
      <Form {...form}>
...
export default SportBranchForm;
